...
<div class="sub__container">
	...
	<div class="page-write">
					...
					<div class="fixed-table__thead">
						<table class="fixed-table">
							...
							<thead>
								<tr>
									<th scope="col">구분</th>
									<th scope="col">데이터셋ID</th>
									<th scope="col">데이터셋명</th>
			...
			<div class="sub__content" v-if="dataModel.modelId">
				...
				<table class="form-table">
					...
					<tr>
						...
						<th scope="row"><i class="icon__require" v-if="dataset.dataOfferType == 'file'">*</i>확장자</th>
						<td>
							<select class="select" name="extension" ref="extension" v-model="dataset.extension" title="확장자" :disabled="dataset.dataOfferType!='file'" :required="dataset.dataOfferType == 'file'">
								<option value="" disabled>선택</option>
					...
					<tr>
						...
						<td colspan="3">
							<select class="select" name="license" ref="license" v-model="dataset.license" title="라이선스">
								<option value="" disabled>선택</option>
			...
			<div class="sub__content">
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<input class="input" type="text" value="등록" disabled>
						</td>
				...
				<table class="board-table">
					...
					<tbody>
						<tr v-for="(output, index) in dataset.datasetOutputList">
							...
							<td>
								<input class="hidden" :name="'datasetOutputList['+index+'].realColumnName'" v-model="dataset.datasetOutputList[index].realColumnName"/>
		...
		<div class="sub__bottom">
			<div class="button__group">
				<a class="button button__primary" href="#none" @click="createDataset">저장</a>
<!-- 				<a class="button button__primary" href="#none">아답터신청</a> -->
...
<!-- //main -->
<script>
validate.validators.imageFile = function(value, options, key, attributes) {
	if(!options.exists){
		...
		methods : {
			createDataset: function(){
				...
				request.done(function(data){
					Modal.OK();
					location.href = SMC_CTX + "/mypage/dataset/pageList.do?nav=MNU043";
				});
			},
