	...
	<form>
		<fieldset>
			...
			<div class="button__group">
				<button class="button__primary" type="button" @click="createPricePolicies">저장</button>
				<button class="button__secondary" type="button" onclick="location.href='<c:url value="/pricePolicies/pageList.do"/>'">취소</button>
			</div>
		</fieldset>
	</form>
</div>
	...
	vm = new Vue({
		...
		methods: {
			createPricePolicies: function(){
				...
				var request = $.ajax({
					method: "POST",
					url: N2M_CTX + "/pricePolicies/create.do",
