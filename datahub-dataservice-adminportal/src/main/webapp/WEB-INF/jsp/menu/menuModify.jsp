...
<div id="content" v-cloak>
	<h3 class="content__title">메뉴수정</h3>
	<form>
	  <fieldset>
	        ...
	        <table class="table--row">
	          ...
	          <tbody>
	            ...
	            <tr>
	              ...
	              <td colspan="3">
	                  <input class="input__checkbox" id="check1" type="checkbox" v-model="menu.menuUseFl" ref="menuUseFl" true-value="Y" false-value="N" required><label class="label__checkbox" for="check1">표시</label>
	              </td>
	            </tr>
	          </tbody>
	        </table>
	    ...
	    <div class="button__group">
	      <button class="button__primary" type="button" @click="modifyMenu">저장</button>
	      <c:if test="${deleteYn eq 'Y'}">
			<button class="button__secondary" type="button" @click="removeMenu">삭제</button>
	      </c:if>
	      <button class="button__secondary" type="button" onclick="location.href='<c:url value="/menu/pageDetail.do?menuOid=${param.menuOid}"/>'">취소</button>
	    </div>
	  </fieldset>
	</form>
